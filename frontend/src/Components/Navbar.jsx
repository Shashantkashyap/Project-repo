          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center sm:space-x-4">
            ...
            {/* {!isAuthenticated && (
              <div className="flex flex-wrap items-center ml-5 gap-x-6 gap-y-1 text-sm sm:text-base max-w-[70%]">
                ...
                <span className="text-gray-800 mr-4">{decryptData(name, import.meta.env.VITE_SECRET_KEY) || <span className='italic text-gray-400'>N/A</span>}</span>
                <span className="font-semibold text-blue-700">Roll No.:</span>
                <span className="text-gray-800 mr-4">{decryptData(roll_no, import.meta.env.VITE_SECRET_KEY) || <span className='italic text-gray-400'>N/A</span>}</span>
                <span className="font-semibold text-blue-700">SSO-ID:</span>
                <span className="text-gray-800 mr-4">{decryptData(sso_id, import.meta.env.VITE_SECRET_KEY) || <span className='italic text-gray-400'>N/A</span>}</span>
                <span className="font-semibold text-blue-700">EXAM:</span>
                <span className="text-gray-800">{decryptData(exam_name, import.meta.env.VITE_SECRET_KEY) || <span className='italic text-gray-400'>N/A</span>}</span>
              </div>
            )} */}
